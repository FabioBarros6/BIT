...
namespace CRUD
{
    public partial class Form1 : Form
    {
        ...
        {
            // Busca do nome pesquisado no banco de dados
        ...
        {
            // Edição/Atualização de dados no banco de dados
            strSql = "update tb_crud set Id=@Id, Nome=@Nome, Endereço=@Endereço, CEP=@CEP, Bairro=@Bairro, Cidade=@Cidade, UF=@UF, Telefone=@Telefone where Nome=@Nome";
            MySqlCommand cmd = new MySqlCommand(strSql, db_Con);
        ...
        private void tsbExcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                // excluir dados do nome selecionado
                strSql = "delete from tb_crud where Nome=@Nome";
                MySqlCommand cmd = new MySqlCommand(strSql, db_Con);
